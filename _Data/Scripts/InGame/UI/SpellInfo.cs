...
public class SpellInfo : MonoBehaviour {
    ...
    public void getname(int id)
    {
        switch (id)
        {
            ...
            case 3:
                myspellname = "유체화";
                myspelldescription = "챔피언이 10초 동안 유닛과 충돌하지 않게 되며 이동 속도가 상승합니다. 이동 속도는 2초동안 점차 빨라져 28%까지 상승합니다.";
                break;
            case 4:
                myspellname = "회복";
                myspelldescription = "챔피언과 대상 아군의 체력을 90만큼 회복시키고 1초 동안 이동 속도가 30% 증가합니다. 최근 소환사 주문 회복의 영향을 받은 유닛의 경우 치유량이 절반만 적용됩니다.";
                break;
            case 5:
                myspellname = "강타";
                myspelldescription = "대상 에픽 및 대형/중형 몬스터, 혹은 적 미니언에게 390의 고정 피해를 입힙니다. 몬스터에게 사용하면 체력도 70(+60)만큼 회복됩니다.";
                break;
            case 6:
                myspellname = "순간이동";
                myspelldescription = "4.5초 동안 정신 집중을 한 후 아군 미니언이나 포탑, 혹은 와드로 순간이동합니다.\n\n다시 사용하면 순간이동이 취소되며 순간이동에 240초의 재사용 대기시간이 적용됩니다.";
                break;
            case 7:
                myspellname = "점화";
                myspelldescription = "적 챔피언을 불태워 5초 동안 80의 고정 피해를 입히고 모습을 드러내며 치료 효과를 감소시킵니다.";
                break;
            case 8:
                myspellname = "방어막";
