...
public class UISkill : MonoBehaviour {
    ...
    {
        HealthBar.value = cd.mystat.Hp / cd.mystat.MaxHp;
        HealthBar.text = Mathf.FloorToInt(cd.mystat.Hp).ToString() + " / " + Mathf.FloorToInt(cd.mystat.MaxHp).ToString();

        ManaBar.value = cd.mystat.Mp / cd.mystat.MaxMp;
        ManaBar.text = Mathf.FloorToInt(cd.mystat.Mp).ToString() + " / " + Mathf.FloorToInt(cd.mystat.MaxMp).ToString();
    }
