...
public class SkillInfo : MonoBehaviour
{
    ...
    public int Acalculate(string Astat, float Avalue)
    {
        ...
        {
            case "AD":
                result = cd.totalstat.Attack_Damage;
                break;

            case "AP":
                result = cd.totalstat.Ability_Power;
                break;

            case "DEF":
                result = cd.totalstat.Attack_Def;
                break;

            case "MDEF":
                result = cd.totalstat.Ability_Def;
                break;

            case "maxHP":
                result = cd.totalstat.MaxHp;
                break;

            case "maxMP":
                result = cd.totalstat.MaxMp;
                break;

            case "minusHP":
                result = cd.totalstat.MaxHp - cd.totalstat.Hp;
                break;

            case "Critical":
                result = cd.totalstat.Critical_Percentage;
                break;
